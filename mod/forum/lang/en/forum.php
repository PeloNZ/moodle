...
$string['modeflatratedhighestfirst'] = 'Display replies flat, with rated highest first';
$string['modeflatratedlowestfirst'] = 'Display replies flat, with rated lowest first';
